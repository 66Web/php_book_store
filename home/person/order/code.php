					...
					<div class='floorFooter2Right'>
						<table width='100%'>
							...
							<?php
                                ...
                                $sql="select indent.price,indent.num,book.name,book.img,book.supplier from indent,book where indent.book_id=book.id and indent.code='{$code}' and book.supplier='{$user_id}'";
                                $rst=mysql_query($sql);
                                ...
                                if($hangnum == 0){
                                    ...
                                    $fenye_sel = "select indent.price,indent.num,book.name,book.img,book.supplier from indent,book where indent.book_id=book.id and indent.code='{$code}' and book.supplier='{$user_id}' limit $start,$size";
